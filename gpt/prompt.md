...
- <https://www.promptingguide.ai/zh>: 非常好且全面的 prompt 教程, 从理论和实践对如何写好 prompt 进行教学
- <https://learningprompt.wiki/zh-Hans/>: 补充 prompt 教程

### 补充

- 不同的要点可以用空格隔开
- 指定输出时, 可以给出一些具体的例子: 专业术语是 few shot, 通俗理解就是给出一些具体的例子让 gpt 去更好的理解

## Prompt 案例

通过分析实际应用场景的案例, 如小红书，周报生成器，代码分析器等, 通过使用和观察别人的具体场景, 来培养具体写 Prompt 的感觉
